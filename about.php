    ...
    <div class="container">
        <div data-aos="fade-right" data-aos-duration="1000" class="row">
            <div class="col-lg-6 offset-lg-6 about-text">
                ...
                <p class="lwhatis2"> ZelCash is minable making distribution fair. ZelNodes are soon to be added, and will allow holders of ZelCash to operate a ZelNode, receiving a portion of blockreward for operating it. ZelCash is the means of transacting in the Zel Ecosystem. It will always be a key part of the Zel Ecosystem.</p>
                <div class="centerbuttons">
                    <a href="./pdf/zelcash_whitepaper_v2_English.pdf" class="site-btn sb-gradients mt-5" target="_blank">Whitepaper 2.0</a>
                    <a href="https://explorer.zel.cash/address/t1W3DXSzNbXPWF7ghEU3xcqjLfBAKJGcmN4" class="site-btn sb-gradients sbg-line mt-5" target="_blank">Devfund</a>
        ...
        <div data-aos="fade-left" data-aos-duration="1000" class="about-img">
            ...
            <div data-paroller-factor="0.1" data-paroller-type="foreground" data-paroller-direction="vertical">
                <img src="./img/question.svg" class="question-img">
            </div>
        </div>
    </div>
</section>