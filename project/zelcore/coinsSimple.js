const coins = {
  zelcash : {
    ...
    addresses : [],
    api : [
      "https://explorer.zel.zelcore.io/api/", "https://explorer.zel.cash/api/",
      "https://explorer2.zel.cash/api/", "https://explorer.zelcash.online/api/",
    ...
    type : "zcash",
    explorer : [
      "https://explorer.zel.zelcore.io/tx/", "https://explorer.zel.cash/tx/",
      "https://explorer2.zel.cash/tx/", "https://explorer.zelcash.online/tx/",
      "https://explorer-asia.zel.cash/tx/"
    ],
    logolink : "./img/assets/ZEL.svg",
    node : [
      "explorer.zel.zelcore.io", "explorer.zel.cash", "explorer2.zel.cash",
      "explorer.zelcash.online"
    ],
    fee : 0.00001,
    feepolicy : {economy : 1, normal : 5, fast : 10},
    color : "#183c87"
  },
  testnet : {
    coin : "testnet",
  ...
  bitcoin : {
    ...
    addresses : [],
    api : [
      "https://explorer.btc.zelcore.io/api/", "https://insight.bitpay.com/api/",
    ...
    type : "btc",
    explorer : [
      "https://explorer.btc.zelcore.io/tx/", "https://insight.bitpay.com/tx/",
    ...
    fee : 0.0000226,
    feepolicy : {economy : 20, normal : 100, fast : 180},
    color : "#f7931a"
  },
  ethereum : {
    coin : "ethereum",
    ...
    fee : 35000,
    feepolicy : {economy : 4, normal : 8, fast : 14},
    color : "#b0b0b0",
  ...
  litecoin : {
    ...
    type : "btc",
    explorer : [
      "https://explorer.ltc.zelcore.io/tx/", "https://insight.litecore.io/tx/",
      "https://litecoinblockexplorer.net/tx/"
    ],
    logolink : "./img/assets/LTC.svg",
    node : [
      "explorer.ltc.zelcore.io", "insight.litecore.io",
      "litecoinblockexplorer.net"
    ],
    fee : 0.0004,
    feepolicy : {economy : 200, normal : 500, fast : 1000},
    color : "#385d9a"
  },
  zcash : {
    coin : "zcash",
    ...
    api : [
      ...
      "https://explorer2.zecmate.com/api/", "https://explorer.zecmate.com/api/",
    ...
    explorer : [
      ...
      "https://explorer2.zecmate.com/tx/", "https://explorer.zecmate.com/tx/",
      "https://explorer.z.cash/tx/"
    ],
    logolink : "./img/assets/ZEC.svg",
    node : [
      "explorer2.zec.zelcore.io", "explorer.zec.zelcore.io",
      "explorer2.zecmate.com", "explorer2.zecmate.com", "explorer.z.cash"
    ],
    fee : 0.0000226,
    feepolicy : {economy : 1, normal : 5, fast : 10},
    color : "#f4b728"
  ...
  bitcoinz : {
    ...
    explorer : [
      ...
      "https://explorer.btcz.zelcore.io/tx/", "https://explorer.btcz.rocks/tx/"
    ],
    logolink : "./img/assets/BTCZ.svg",
    node : [
      "explorer2.btcz.zelcore.io", "explorer.btcz.zelcore.io",
      "explorer.btcz.rocks"
    ],
    fee : 0.00001,
    feepolicy : {economy : 1, normal : 5, fast : 10},
  ...
  ravencoin : {
    ...
    addresses : [],
    api : [
      "https://api.ravencoin.org/api/", "https://explorer.rvn.zelcore.io/api/",
    ...
    type : "btc",
    explorer : [
      "https://explorer.rvn.zelcore.io/tx/", "https://api.ravencoin.org/tx/",
    ...
    node : [
      "explorer.rvn.zelcore.io", "api.ravencoin.org", "ravencoin.network",
      "ravenexplorer.minermore.com", "explorer.ravenland.org"
    ],
    fee : 0.00001,
    feepolicy : {economy : 4, normal : 8, fast : 16},
    color : "#f05239"
  },
  bitcore : {
    coin : "bitcore",
  ...
  binance : {
    ...
    node : [ "https://mainnet.infura.io/v3/97c8bf358b9942a9853fab1ba93dc5b3" ],
    fee : 63000,
    feepolicy : {economy : 10, normal : 15, fast : 20},
  ...
  bitcoingold : {
    ...
    fee : 0.0000226,
    feepolicy : {economy : 3, normal : 5, fast : 10},
    color : "#eba809"
  },
  snowgem : {
    coin : "snowgem",
    ...
    type : "zcash",
    explorer : [
      "https://explorer.xsg.zelcore.io/tx/", "https://explorer.snowgem.org/tx/"
    ],
  ...
  komodo : {
    ...
    addresses : [],
    api : [
      "https://explorer.kmd.zelcore.io/api/", "https://www.kmdexplorer.io/api/"
    ],
    pathunix : "komodo",
    path : "Komodo",
    unit : "KMD",
    ...
    type : "zcash",
    explorer : [
      "https://explorer.kmd.zelcore.io/tx/", "https://www.kmdexplorer.io/tx/"
    ],
  ...
  zcoin : {
    ...
    addresses : [],
    api : [
      "https://explorer.zcoin.zelcore.io/api/", "https://insight.zcoin.io/api/",
    ...
    type : "btc",
    explorer : [
      "https://explorer.zcoin.zelcore.io/tx/", "https://insight.zcoin.io/tx/",
      "https://explorer.zcoin.io/tx/"
    ],
    logolink : "./img/assets/XZC.svg",
    node : [
      "explorer.zcoin.zelcore.io", "insight.zcoin.io", "explorer.zcoin.io"
    ],
    fee : 0.00001,
    feepolicy : {economy : 1, normal : 5, fast : 10},
    color : "#3fad54"
  ...
  usdt : {
    ...
    fee : 0.0000226,
    feepolicy : {economy : 7, normal : 15, fast : 30},
    color : "#26a17a"
  },
  // usdtERC: {
  //   coin: "usdtERC",
  ...
  bitcoincash : {
    ...
    addresses : [],
    api : [
      "bch.imaginary.cash", "blackie.c3-soft.com", "electron.jochen-hoenicke.de"
    ],
    proxy : [
  ...
  dash : {
    ...
    node : [
      "explorer.dash.zelcore.io", "insight.dash.org",
  ...
  monero : {
    ...
    addresses : [],
    api : [
      "https://zel.mymonero.com:8443", "https://api.mymonero.com:8443",
      "https://backend.xmr.zelcore.io", "https://backend2.xmr.zelcore.io",
    ...
    type : "cryptonight",
    explorer : [
      "https://explorer.xmr.zelcore.io/tx/", "https://moneroblocks.info/tx/",
      "https://xmrchain.net/tx/"
    ],
    logolink : "./img/assets/XMR.svg",
    node : [ "explorer.xmr.zelcore.io" ],
    fee : 0.00001,
    feepolicy : {economy : 1, normal : 2, fast : 3},
    color : "#ff6600"
  },
  usdc : {
    coin : "usdc",
  ...
  etc : {
    ...
    node : [
      "https://etc-geth.0xinfra.com", "https://etc-parity.0xinfra.com",
      "https://etc.guarda.co", "https://ethereumclassic.network",
      "https://web3.gastracker.io"
    ],
    fee : 35000,
    feepolicy : {economy : 0.1, normal : 0.3, fast : 1},
    color : "#34fa99",
    contractAddress : "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
    decimals : 18
  },
  ...
  genesis : {
    ...
    fee : 0.00001,
    feepolicy : {economy : 5, normal : 10, fast : 20},
    color : "#1ea1ef"
  },
  por : {
    coin : "por",
  ...
  bzedge : {
    ...
    addresses : [],
    api : [
      "https://explorer.bze.zelcore.io/api/", "https://explorer.getbze.com/api/"
    ],
    pathunix : "bzedge",
    path : "BZEdge",
    unit : "BZE",
    ...
    type : "zcash",
    explorer : [
      "https://explorer.bze.zelcore.io/tx/", "https://explorer.getbze.com/tx/"
    ],
  ...
  bithereum : {
    ...
    proxy : [
      "https://proxy.bth.zelcore.io/?server=127.0.0.1&port=50002&contype=tls&coin=bithereum&call=", "https://proxy.genx.zelcore.io/?server=explorer.bth.zelcore.io&port=50002&contype=tls&coin=bithereum&call="
    ],
    pathunix : "bithereum",
    path : "Bithereum",
    unit : "BTH",
  ...
  groestlcoin : {
    ...
    addresses : [],
    api : [
      "explorer.grs.zelcore.io", "electrum10.groestlcoin.org",
      "electrum11.groestlcoin.org", "electrum13.groestlcoin.org",
  ...
  bnbbinance : {
    ...
    name : "BNB",
    uri : [
      "binancecoin", "binancechain", "binance", "bnbbinance", "binancebnb",
      "bnb"
    ],
    slip : 714,
    addresses : [],
    api : [
      "https://dex.binance.org/", "https://dex-european.binance.org/",
    ...
    fee : 0.00125,
    feepolicy : {economy : 0.5, normal : 1, fast : 2},
    color : "#f3ba2f",
    decimals : 8
  },
  ripple : {
  ...
  axe : {
    ...
    addresses : [],
    api : [
      "https://explorer.axe.zelcore.io/api/", "https://insight.axecore.net/api/"
    ],
    pathunix : "axecore",
    path : "AxeCore",
    unit : "AXE",
    ...
    type : "btc",
    explorer : [
      "https://explorer.axe.zelcore.io/tx/", "https://insight.axecore.net/tx/"
    ],
  ...
  beaxy : {
    ...
    name : "Beaxy",
    uri :
        [ "beaxy", "beaxyexchangetoken", "beaxytoken", "beaxyexchange", "bxy" ],
    addresses : [],
    api : [
  ...
  eos : {
    ...
    api : [
      "https://api.eossweden.org", "https://api.eosdetroit.io",
      "https://eos.eoscafeblock.com", "https://eosbp.atticlab.net",
    ...
    type : "eos",
    explorer : [
      "https://eosflare.io/tx/", "https://www.eosx.io/tx/",
  ...
  dogecoin : {
    ...
    addresses : [],
    api : [
      "explorer.doge.zelcore.io", "electrum3.cipig.net", "electrum2.cipig.net",
      "electrum1.cipig.net"
    ],
    proxy : [
      "https://proxy.doge.zelcore.io/?server=127.0.0.1&port=55002&contype=tls&coin=dogecoin&call=", "https://proxy.zel.network/?server=127.0.0.1&port=55002&contype=tls&coin=dogecoin&call=", "https://proxy.bth.zelcore.io/?server=electrum3.cipig.net&port=10060&contype=tls&coin=dogecoin&call=", "https://proxy.genx.zelcore.io/?server=electrum3.cipig.net&port=10060&contype=tls&coin=dogecoin&call=", "https://proxy.sin.zelcore.io/?server=electrum3.cipig.net&port=10060&contype=tls&coin=dogecoin&call=",
    ...
    type : "electrum",
    explorer :
        [ "https://explorer.doge.zelcore.io/tx/", "http://dogechain.info/tx/" ],
  ...
  digibyte : {
    ...
    addresses : [],
    api : [
      "explorer.dgb.zelcore.io", "electrum3.cipig.net", "electrum2.cipig.net",
      "electrum1.cipig.net"
    ],
    proxy : [
    ...
    type : "electrum",
    explorer : [
      "https://explorer.dgb.zelcore.io/tx/", "https://digiexplorer.info/tx/"
    ],
  ...
  sinovate : {
    ...
    fee : 0.00001,
    feepolicy : {economy : 2500, normal : 5000, fast : 10000},
    color : "#ffffff"
  },
  neo : {
    coin : "neo",
    ...
    explorer :
        [ "https://neoscan.io/transaction/", "https://neotracker.io/tx/" ],
    logolink : "./img/assets/NEO.svg",
    node : [
      "http://seed9.ngd.network:10332", "https://seed0.cityofzion.io:443",
      "http://rpc1.go.nspcc.ru:10332", "http://seed1.red4sec.com:10332",
      "http://seed1.aphelion-neo.com:10332", "http://seed5.neo.org:10332"
    ],
    fee : 0,
    feepolicy : {economy : 0, normal : 0, fast : 0},
    color : "#00E599",
    decimals : 18
  },
  gas : {
  ...
  stellar : {
    ...
    type : "stellar",
    explorer : [
      "https://stellarscan.io/transaction/", "https://steexp.com/tx/",
      "https://stellarchain.io/tx/"
    ],
    logolink : "./img/assets/XLM.svg",
    node : [
      "https://stellarscan.io/", "https://steexp.com/",
      "https://stellarchain.io/"
    ],
    fee : 0.00001,
    feepolicy : {economy : 0.00001, normal : 0.00005, fast : 0.0001},
    color : "#08b5e5"
  },
  tron : {
    coin : "tron",
    ...
    type : "tron",
    explorer : [
      "https://www.trxplorer.io/tx/", "https://tronscan.org/#/transaction/"
    ],
  ...
  veriblock : {
    ...
    fee : 0.00045,
    feepolicy : {economy : 1.5, normal : 2, fast : 5},
    color : "#12284B"
  },
  huobitoken : {
    coin : "huobitoken",
